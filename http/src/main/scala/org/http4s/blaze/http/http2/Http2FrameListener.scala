...
trait Http2FrameListener {
  ...
  /** Called on successful receipt of a RST_STREAM frame
    ...
    *
    * @param streamId stream id associated with this RST_STREAM frame. The codec will never set this to 0.
  ...
  /** Called on successful receipt of a PUSH_PROMISE frame
    ...
    *
    * @param streamId stream id associated with this PUSH_PROMISE frame. The codec will never set this to 0.
    * @param promisedId This stream id must be a stream in the idle state. The codec will never set this to 0.
  ...
  /** Called on successful receipt of a GOAWAY frame
    ...
    *
    * @param lastStream last stream id that may have been processed by the peer.
  ...
  /** Called on successful receipt of a WINDOW_UPDATE frame
    ...
    *
    * @param streamId stream id to update. Stream id of 0 means this is for the session flow window.
